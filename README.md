...
- 마이페이지 개인 메모 탭에서 작성한 메모를 최근 수정 순으로 조회
- 마이페이지 공부 달력에서 날짜별 학습 노트 작성·수정·삭제, 완료한 퀴즈와 스크랩 이력 확인
...
- 신규 단어 요청과 수정 요청에 요청한 사용자 이메일 표시
...
| `favorites` | 사용자별 스크랩 |
| `scrapHistory` | 스크랩을 해제해도 남는 날짜별 스크랩 이력 |
| `studyNotes` | 사용자·날짜별 공부 노트 |
